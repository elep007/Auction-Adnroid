...
//        getSupportActionBar().hide(); //hide the title bar
    ...
    public void login() {
        ...
        if (!validate()) {
            Toast.makeText(this,"Enter your username and mobile number.",Toast.LENGTH_LONG);
            return;
        }
        ...
        String mobile = selectedCountryCode+_mobileText.getText().toString();
        ...
        try {
            Ion.with(this)
                    .load(Common.getInstance().getBaseURL()+"resetpassword.php")
                    ...
                    .setCallback(new FutureCallback<JsonObject>() {
                        ...
                        public void onCompleted(Exception e, JsonObject result) {
                            ...
                            if (result != null) {
                                ...
                                if (status.equals("ok")) {
                                    Toast.makeText(getBaseContext(),"Your password is reseted and sent to your email.",Toast.LENGTH_LONG).show();
                                    //categories loading
                                } else if (status.equals("nouser")) {
                                    Toast.makeText(getBaseContext(),"Enter your correct username.",Toast.LENGTH_LONG).show();
                                } else if(status.equals("nomobile")) {
                                    Toast.makeText(getBaseContext(),"Wrong mobile number.",Toast.LENGTH_LONG).show();
                                }
                            } else {
    ...
    public boolean validate() {
        ...
        if (mobile.isEmpty()) {
            _mobileText.setError("Enter your password");
            valid = false;
        } else {
