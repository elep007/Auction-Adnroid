...
//        getSupportActionBar().hide(); //hide the title bar
        ...
        _emailText = (EditText) findViewById(R.id.login_input_email);
        _mobileText = (EditText) findViewById(R.id.input_mobile);
        _passwordText = (EditText) findViewById(R.id.login_input_password);
        _loginButton = (Button) findViewById(R.id.btn_login);
        _signupLink = (TextView) findViewById(R.id.link_signup);
        _guestLink = (TextView) findViewById(R.id.link_guest);
        ...
        _guestLink.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Start the Signup activity
                onLoginSuccess("guest12345","guest");
            }
        });
        ...
        ImageView imgMoble=(ImageView) findViewById(R.id.imgMobileToggle);
        ImageView imgUser=(ImageView) findViewById(R.id.imgUserToggle);

        final RelativeLayout layUser=(RelativeLayout) findViewById(R.id.layUser);
        final LinearLayout layMobile=(LinearLayout) findViewById(R.id.layMobile);
        imgMoble.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                isMobileMode=true;
    ...
    public void login() {
        ...
        if (!validate()) {
            onLoginFailed("Enter your username and password.");
            return;
        }
        ...
        String email =isMobileMode?selectedCountryCode+_mobileText.getText().toString(): _emailText.getText().toString().toLowerCase ();
    ...
    try {
        Ion.with(this)
                .load(Common.getInstance().getBaseURL()+"verifyuser.php")
                    ...
                    public void onCompleted(Exception e, JsonObject result) {
                        ...
                        if (result != null) {
                            ...
                            if (status.equals("ok")) {
                                ...
                                onLoginSuccess(_emailText.getText().toString().toLowerCase (),role);
                                //categories loading
                            } else if (status.equals("nouser")) {
                                onLoginFailed("You are not signed");
    ...
    public boolean validate() {
        ...
        if (isMobileMode){
            if (mobile.isEmpty() || mobile.length()<8) {
                _mobileText.setError("Enter your mobile number");
                valid = false;
            } else {
